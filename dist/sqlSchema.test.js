...
describe("getSchema", () => {
    ...
    expect(query).toMatchInlineSnapshot(`
      ...
      `)));
    it(...parseTest("SELECT * FROM (SELECT * FROM FRUIT WHERE id = ?)", (query) => expect(query).toMatchInlineSnapshot(`
        {
          "inputFields": [
            {
              "idx": 1,
      ...
      `)));
    it.only(...parseTest("SELECT id FROM (SELECT * FROM fruit WHERE color = 'red') UNION ALL SELECT fruitId FROM (SELECT * FROM stock WHERE fruitId = ?)", (query) => expect(query).toMatchInlineSnapshot(`
        {
          "inputFields": [
            {
              "idx": 1,
